    ...
    sliderPicker.on('input:change', function (color, changes) {
        col = color.hexString;
    })
    ...
    function screenChange(e) {
        ...
        // document.getElementById("canvas").style.marginLeft = "200px";
        canvas.width = size;
        canvas.height = size;

        let demos = document.getElementsByClassName("demos");
        // demos.style.display = "red";
    ...
    screenChange(e) // Call listener function at run time
    e.addListener(screenChange) // Attach listener function on state changes
